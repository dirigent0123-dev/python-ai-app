...
def convert_tone(text: str, target_tone: str) -> str:
    tone_descriptions = {
        ...
        "コウペンちゃん風": "コウペンちゃん（こうていペンギンの赤ちゃん）のように、何でも全力で褒めてポジティブに励ます文体。語尾に「！」を多用し、「えらい！」「すごい！」「できてる！」などの褒め言葉を自然に散りばめる。小学校で習う漢字（1〜6年生の学習漢字）は積極的に使い、それ以外の難しい漢字はひらがなで書く。短い文を連ねるリズミカルな文体。",
    }
